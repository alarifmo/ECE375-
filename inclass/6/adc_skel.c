...
PORTF|= 0x80; //single-ended, input PORTF bit 7, right adjusted, 10 bits
...
while(1){ 
  ...
  ADCSRA=(0<<ADIF);//spin while interrupt flag not set

   ADCSRA=(0<<ADIF); //its done, clear flag by writing a one 
